...
if __name__ == "__main__":
    ...
    plot_sequential(loss_hist_1["train loss"], "1 Encoder - ViT - Resnet KD", "Epoch", "Train Loss")
    plot_sequential(loss_hist_1["val accuracy"], "1 Encoder - ViT - Resnet KD", "Epoch", "Validation Accuracy")

    plot_sequential(loss_hist_2["train accuracy"], "2 Encoder - ViT - Resnet KD", "Epoch", "Train Accuracy")
    plot_sequential(loss_hist_2["train loss"], "2 Encoder - ViT - Resnet KD", "Epoch", "Train Loss")
    plot_sequential(loss_hist_2["val accuracy"], "2 Encoder - ViT - Resnet KD", "Epoch", "Validation Accuracy")

    plot_sequential(loss_hist_3["train accuracy"], "3 Encoder - ViT - Resnet KD", "Epoch", "Train Accuracy")
    plot_sequential(loss_hist_3["train loss"], "3 Encoder - ViT - Resnet KD", "Epoch", "Train Loss")
    plot_sequential(loss_hist_3["val accuracy"], "3 Encoder - ViT - Resnet KD", "Epoch", "Validation Accuracy")
